...
export declare namespace CreatingReferrals {
...
export class CreatingReferrals {
    constructor(protected readonly _options: CreatingReferrals.Options) {}

    /**
     * @param {ReferralExchange.CreateLinkReqUpsert} request
     * @param {CreatingReferrals.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async createUpsertLink(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: { ...request, referrerInstitutionIdType: "hci" },
