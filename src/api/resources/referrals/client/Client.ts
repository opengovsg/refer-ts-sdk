...
export class Referrals {
    ...
    public async list(
        ...
        const { offset, pageSize, status, role, referrerId, referrerIdType, patientUin, hciCode, institutionId } =
            request;
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            headers: {
                ...
                "X-Fern-SDK-Version": "0.0.0-develop-alpha-1772437212",
                "User-Agent": "@opengovsg/refx-ts-sdk/0.0.0-develop-alpha-1772437212",
