...
export class Links {
    ...
    ): core.HttpResponsePromise<ReferralExchange.ReferralLinkDto> {
    ...
    private async __createUpsertLink(
        request: ReferralExchange.CreateLinkReqUpsert,
        requestOptions?: Links.RequestOptions,
    ): Promise<core.WithRawResponse<ReferralExchange.ReferralLinkDto>> {
        ...
        if (_response.ok) {
            return { data: _response.body as ReferralExchange.ReferralLinkDto, rawResponse: _response.rawResponse };
        }
