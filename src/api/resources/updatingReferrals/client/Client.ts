...
export declare namespace UpdatingReferrals {
...
export class UpdatingReferrals {
    constructor(protected readonly _options: UpdatingReferrals.Options) {}

    /**
     * @param {string} referralId - Referral ID
     * @param {ReferralExchange.UpdatingReferralsDeleteRequest} request
     * @param {UpdatingReferrals.RequestOptions} requestOptions - Request-specific configuration.
     *
