...
export declare namespace ReferralNotes {
...
export class ReferralNotes {
    constructor(protected readonly _options: ReferralNotes.Options) {}

    /**
     * @param {string} referralId - Referral ID
     * @param {ReferralExchange.CreateNoteReq} request
     * @param {ReferralNotes.RequestOptions} requestOptions - Request-specific configuration.
     *
